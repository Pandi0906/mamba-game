...
medium_font = pygame.font.SysFont('times new roman', 30, True)
large_font = pygame.font.SysFont('times new roman', 50, True, True)
clock = pygame.time.Clock()

canvas = pygame.display.set_mode((WINDOW_WIDTH, WINDOW_HEIGHT))
pygame.display.set_caption('Mamba Game')
...
def start_game():
    canvas.fill(BLACK)
    start_font1 = large_font.render("Welcome to Mamba game", True, GREEN)
...
def snake(snakelist, direction):
    ...
    for XnY in snakelist[1:-1]:
        pygame.draw.rect(canvas, RED, (XnY[0], XnY[1], SNAKE_WIDTH, SNAKE_WIDTH))
